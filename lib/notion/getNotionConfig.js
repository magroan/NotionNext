...
export async function getConfigMapFromConfigPage(allPages) {
  ...
  if (pageIds?.length === 0) {
    console.error(
      "[Notion\u8A2D\u5B9A]\u53D6\u5F97\u3057\u305F\u8A18\u4E8B\u306E\u30EA\u30B9\u30C8\u304C\u7A7A\u3067\u3059\u3002Notion\u30C6\u30F3\u30D7\u30EC\u30FC\u30C8\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
      collectionQuery,
      collection,
      collectionView,
      viewIds,
  ...
  for (let i = 0; i < pageIds.length; i++) {
    ...
    if (properties) {
      // 将表格中的字段映射成 英文
      const config = {
        enable: (properties["\u6709\u52B9\u5316"] || properties.Enable) === 'Yes',
        key: properties["\u8A2D\u5B9A\u540D"] || properties.Name,
        value: properties["\u8A2D\u5B9A\u5024"] || properties.Value
      };
  ...
  try {
    ...
    console.warn("INLINE_CONFIG\u306E\u8A2D\u5B9A\u3092\u89E3\u6790\u4E2D\u306B\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F\u3002JSON\u5F62\u5F0F\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002", err);
  }
  return combine;
}
...
export function parseConfig(configString) {
  ...
  try {
    ...
    console.warn(
      "INLINE_CONFIG \u306E\u89E3\u6790\u4E2D\u306B\u30A8\u30E9\u30FC\u304C\u767A\u751F\u3057\u307E\u3057\u305F\u3002JSON \u30D5\u30A9\u30FC\u30DE\u30C3\u30C8\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002",
      evalError
    );
    return {};
  }
