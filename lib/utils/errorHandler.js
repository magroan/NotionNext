...
export class NetworkError extends AppError {
  constructor(message = "\u30CD\u30C3\u30C8\u30EF\u30FC\u30AF\u63A5\u7D9A\u306B\u5931\u6557\u3057\u307E\u3057\u305F", details = null) {
...
export class ApiError extends AppError {
  constructor(message = "API\u30EA\u30AF\u30A8\u30B9\u30C8\u306B\u5931\u6557\u3057\u307E\u3057\u305F", statusCode = 500, details = null) {
...
export class ValidationError extends AppError {
  constructor(message = "\u30C7\u30FC\u30BF\u691C\u8A3C\u306B\u5931\u6557\u3057\u307E\u3057\u305F", details = null) {
...
export class ErrorHandler {
  ...
  static handleApiError(error) {
    if (error.response) {
      ...
      // 请求已发出但没有收到响应
      throw new NetworkError("\u30CD\u30C3\u30C8\u30EF\u30FC\u30AF\u63A5\u7D9A\u306E\u30BF\u30A4\u30E0\u30A2\u30A6\u30C8\u307E\u305F\u306F\u30B5\u30FC\u30D0\u30FC\u304C\u5FDC\u7B54\u3057\u3066\u3044\u307E\u305B\u3093\u3002");
    } else {
      // 其他错误
      throw new AppError(error.message || "\u4E0D\u660E\u306A\u30A8\u30E9\u30FC");
    }
  }
