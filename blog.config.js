...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '2b0b219f5e518183945deb507bf944fa',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'asami', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '情報科の教員', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://asami.chiba.jp', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '情報,高校,情報科,ICT,情報学,DX,教育,情報教育', // 网站关键词 英文逗号隔开
