...
module.exports = {
  ...
  COMMENT_GISCUS_STRICT:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_STRICT || '1',   // ← 追加

  COMMENT_GISCUS_REACTIONS_ENABLED:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_REACTIONS_ENABLED || '1',
  // リアクション（絵文字）を有効化するか（1=有効、0=無効）
  COMMENT_GISCUS_EMIT_METADATA:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_EMIT_METADATA || '1',
  // メタデータの取得を有効にするか（1=有効）
  COMMENT_GISCUS_INPUT_POSITION:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_INPUT_POSITION || 'top',
